    ...
    >
      <div className="flex flex-col sm:flex-row sm:justify-between items-center sm:items-start pb-48 space-y-8 sm:space-y-0">
        <div className="text-center sm:text-left">
          ...
          <p className={`mb-4 text-lg ${isDark ? "text-gray-300" : "text-gray-900"}`}>
        ...
        <ul className="space-y-5 text-center sm:text-right">
          <li>
            ...
            Email:{" "}
            <a href="mailto:mateusinacio32@gmail.com" className={linkStyles}>
          ...
          <li>
            ...
            >
              linkedin.com/in/matheusnunesinacio
            </a>
          </li>
          <li>
