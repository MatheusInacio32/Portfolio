...
export default function Sobre() {
  return (
    ...
    >
      ...
      <Typed
        strings={[  
          `🚀 Sou um desenvolvedor Front End empolgado por criar soluções Web digitais e inovadoras. Atualmente, atuo como <strong class="text-blue-300 font-semibold">Analista de Suporte</strong>, onde aprimoro minhas habilidades técnicas e analíticas em um ótimo ambiente com muitos bons profissionais. <br>  
